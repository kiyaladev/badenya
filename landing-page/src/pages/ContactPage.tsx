              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    aria-label="Sélectionnez un sujet"
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  >
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="opacity-90">contact@badenya.app</p>
                      <p className="opacity-90">support@badenya.app</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="opacity-90">+221 XX XXX XX XX</p>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1">Bureaux</h3>
                      <p className="opacity-90">Dakar, Sénégal</p>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="opacity-90">Lun - Ven: 9h - 18h</p>
                      <p className="opacity-90">Sam: 9h - 13h</p>
                    </div>
                  </div>
                </div>
              </div>
